...
WISSは、新型コロナ対策として2020年は完全オンライン、2021・2022年はハイブリッドで実施しました。WISS2023は、新型コロナ感染症対策をしつつ、従来の合宿形式（現地参加）で行います。
